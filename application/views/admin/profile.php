            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                <div class="text-center">
                  ...
                  <img class="profile-user-img img-fluid img-circle" src="<?= base_url()?>assets/upload/user/img/<?= $a->nama_file?>" alt="User profile picture">
                </div>
								<?php } ?>		
            ...
            <div class="card">
              <div class="card-header p-2">
                <ul class="nav nav-pills">
                  <li class="nav-item"><a class="nav-link active" href="#setting" data-toggle="tab">Ubah Password</a></li>
                  ...
                  <div class="active tab-pane" id="setting">
                    <form class="form-horizontal">
											<div class="form-group row">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" id="username" disabled="" value="<?= $this->session->userdata('name')?>">
												</div>
											</div>
											<div class="form-group row">
