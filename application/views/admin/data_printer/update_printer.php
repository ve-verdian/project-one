                            ...
                            <div class="card card-danger">
                                ...
                                <form class="form-horizontal" action="<?=base_url('admin/proses_printer_update')?>"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group row">
                                            <label for="serial_number" class="col-sm-2 col-form-label">Serial
                                                Number</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="form-group row">
                                            <label for="posisi_skg" class="col-sm-2 col-form-label">Posisi
                                                Sekarang</label>
                                            <div class="col-sm-10">
                                                <input type="text" name="posisi_skg" class="form-control"
                                                    id="posisi_skg" placeholder="Posisi Sekarang"
                                                    value="<?=$dp->posisi_skg?>">
                                            </div>
                                        </div>
                                        <?php } ?>
