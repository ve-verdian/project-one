        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="<?=base_url('admin/proses_tambah_user')?>" role="form" method="post">
            	...
            	<?php } ?>
                  ...
                  <div class="form-group col-md-4">
                    <label for="username" style="margin-left:20px">Username</label>
										<input type="text" name="username" style="margin-left:20px" class="form-control" id="username" placeholder="Username">
									</div>
                  </div>
									<div class="form-row">
									<div class="form-group col-md-4">
										<label for="email" style="margin-left:20px">Email</label>
										<input type="text" name="email" style="margin-left:20px" class="form-control" id="email" placeholder="Email">
									</div>
                  </div>    
								<div class="form-row">
    							<div class="form-group col-md-4">
										<label for="password" style="margin-left:20px">Password</label>
										<input type="password" name="password" style="margin-left:20px" class="form-control" id="password" placeholder="Password">
									</div>
                </div>
								<div class="form-row">
    							<div class="form-group col-md-4">
										<label for="confirm_password" style="margin-left:20px">Confirm Password</label>
										<input type="password" name="confirm_password" style="margin-left:20px" class="form-control" id="confirm_password" placeholder="Confirm Password">
									</div>
                </div>
                <div class="form-row">  
