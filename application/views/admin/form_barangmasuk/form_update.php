        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form class="form-horizontal" action="<?=base_url('admin/proses_databarang_masuk_update')?>" role="form" method="post">
            	...
            	<?php } ?>
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
											...
											<input type="text" name="id_transaksi" style="margin-left:5px"class="form-control" id="id_transaksi" readonly="readonly" value="<?=$d->id_transaksi?>">
										</div>
										<div class="form-group col-md-3">
											<label for="tanggal" style="margin-left:5px">Tanggal</label>
											<input type="text" name="tanggal" style="margin-left:5px" class="form-control" id="tanggal" readonly="readonly" value="<?=$d->tanggal?>">
										</div>
                  </div>
									<div class="form-group col-md-6">
											<label for="divisi" style="margin-left:5px">Divisi</label>
											<input type="text" name="divisi" style="margin-left:5px" class="form-control" id="divisi" readonly="readonly" value="<?=$d->divisi?>">
                    </div>
                  </div>    
									<div class="form-row">
										<div class="form-group col-md-3">
										...
										<div class="form-group col-md-3">
											...
											<input type="text" name="nama_barang" style="margin-left:25px" class="form-control" id="nama_barang" value="<?=$d->nama_barang?>">
										</div>
									</div>
									<div class="form-row">  
										<div class="form-group col-md-3">
											<label for="jumlah" style="margin-left:25px">Jumlah</label>
											<input type="number" name="jumlah" style="margin-left:25px" class="form-control" id="jumlah" value="<?=$d->jumlah?>">
										</div>
										<div class="form-group col-md-3">
