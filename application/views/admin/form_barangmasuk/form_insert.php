            	...
            	<?php } ?>
                  ...
                  <div class="form-row">
                    ...
                    <label for="id_transaksi" style="margin-left:5px">ID Transaksi</label>
										<input type="text" name="id_transaksi" style="margin-left:5px"class="form-control" id="id_transaksi" readonly="readonly" value="WG-<?=date("Y");?><?=random_string('numeric', 8);?>">
                  </div>
                  <div class="form-group col-md-3">
                    <label for="tanggal" style="margin-left:5px">Tanggal</label>
										<input type="text" name="tanggal" style="margin-left:5px" class="form-control form_datetime" id="tanggal" placeholder="Masukan Tanggal">
									</div>
                  </div>
                    	...
                    	<option value="<?=$ld->kode_divisi?>"><?=$ld->nama_divisi?></option>
                    		<?php } ?>
    							...
    							<div class="form-group col-md-3">
      							...
      							<input type="text" name="kode_barang" style="margin-left:25px" class="form-control" id="kode_barang" placeholder="No. Seri / Kode Barang">
    							</div>
    							<div class="form-group col-md-3">
										<label for="nama_barang" style="margin-left:25px">Nama Barang</label>
										<input type="text" name="nama_barang" style="margin-left:25px" class="form-control" id="nama_barang" placeholder="Nama Barang">
									</div>
                </div>
                <div class="form-row">  
    							<div class="form-group col-md-3">
										<label for="jumlah" style="margin-left:25px">Jumlah</label>
										<input type="number" name="jumlah" style="margin-left:25px" class="form-control" id="jumlah" placeholder="Jumlah">
									</div>
									<div class="form-group col-md-3">
