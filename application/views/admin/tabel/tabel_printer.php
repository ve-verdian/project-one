            ...
            <a href="#" style="margin-bottom:10px;" type="button" class="btn btn-success" name="export_excel"><i class="fa fa-plus-circle" aria-hidden="true"></i> Export Excel</a>
                ...
                <tr>
                  ...
                  <th width="15%"><center>Kepemilikan</th>
									<th width="20%"><center>Posisi Skg</th>
                ...
                <tr>
                  ...
                  <?php foreach($list_data as $dd): ?>
                    ...
                    <td width="12%"><center><?=$dd->qty?></td>
										...
										<td width="50%">
										<center><a type="button" class="btn btn-success center-block"  href="<?=base_url('admin/update_printer/'.$dd->id_printer)?>" name="btn_update" style="margin:auto;"><i class="fas fa-edit"  aria-hidden="true"></i></a>
										<a type="button" class="btn btn-danger btn-delete center-block"  href="<?=base_url('admin/delete_printer/'.$dd->id_printer)?>" name="btn_delete" style="margin:auto;"><i class="fa fa-trash" aria-hidden="true"></i></a>
										</center>
										</td>
                </tr>
									<?php $no++; ?>
