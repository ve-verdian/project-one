          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <a href="<?=base_url('admin/divisi')?>" style="margin-bottom:10px;" type="button"
                    ...
                    <tr>
                      ...
                      <td width="5%">
                        <center><a type="button" class="btn btn-success"
                            href="<?=base_url('admin/update_divisi/'.$dd->id_divisi)?>" name="btn_update"
                            style="margin:auto;"><i class="fas fa-edit" aria-hidden="true"></i></a>
                          <a type="button" class="btn btn-danger btn-delete"
                            href="<?=base_url('admin/delete_divisi/'.$dd->id_divisi)?>" name="btn_delete"
