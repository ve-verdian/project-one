          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <div class="card card-danger">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form class="form-horizontal" action="<?=base_url('admin/proses_satuan_update')?>" role="form"
                  method="post">
                    ...
                    <div class="form-row">
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <input type="text" name="kode_satuan" style="margin-left:5px" class="form-control"
                          id="kode_satuan" placeholder="Kode Satuan" value="<?=$d->kode_satuan?>">
                      </div>
                      <div class="form-group col-md-3">
                        ...
                        <input type="text" name="nama_satuan" style="margin-left:5px" class="form-control"
                          id="nama_satuan" placeholder="Nama Satuan" value="<?=$d->nama_satuan?>">
                      </div>
                    </div>
                    <?php } ?>
                    <!-- /.card-body -->
