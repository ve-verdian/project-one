        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?=base_url('admin/proses_data_keluar')?>" role="form" method="post" class="form-horizontal">
								...
								<div class="card-body">
									...
									<div class="form-row">
										<div class="form-group col-md-2">
											...
											<input type="text" style="margin-left:5px" name="id_transaksi" class="form-control" id="id_transaksi" readonly="readonly" value="<?=$d->id_transaksi?>">
										</div>
										<div class="form-group col-md-2">
											<label for="tanggal" style="margin-left:2px">Tanggal Masuk</label>
											<input type="text" name="tanggal" style="margin-left:2px" class="form-control" id="tanggal" readonly="readonly" value="<?=$d->tanggal?>">
										</div>
										<div class="form-group col-md-2">
											<label for="tanggal_keluar" >Tanggal Keluar</label>
											<input type="text" name="tanggal_keluar" class="form-control form_datetime" id="tanggal_keluar" required="">
										</div>
                  </div>
										<div class="form-group col-md-6">
											<label for="divisi">Divisi</label>
											<input type="text" name="divisi" class="form-control" id="divisi" readonly="readonly" value="<?=$d->divisi?>">
                    </div>
                  </div>    
									<div class="form-row">
										<div class="form-group col-md-3">
											<label for="kode_barang" style="margin-left:25px">No. Seri / Kode Barang</label>
											<input type="text" name="kode_barang" readonly="readonly" style="margin-left:25px" class="form-control" id="kode_barang" value="<?=$d->kode_barang?>">
										</div>
										<div class="form-group col-md-3">
											<label for="nama_barang" style="margin-left:25px">Nama Barang</label>
											<input type="text" name="nama_barang" readonly="readonly" style="margin-left:25px" class="form-control" id="nama_barang" value="<?=$d->nama_barang?>">
										</div>
									</div>
									<div class="form-row">  
										<div class="form-group col-md-3">
											<label for="jumlah" style="margin-left:25px">Jumlah</label>
											<input type="number" name="jumlah" style="margin-left:25px" class="form-control" id="jumlah" max="<?=$d->jumlah?>" value="<?=$d->jumlah?>">
										</div>
										<div class="form-group col-md-3">
									...
									<div class="form-group col-md-6">
                    <label for="unit_order" style="margin-left:20px">Unit Order</label>
                    <select name="unit_order" class="form-control" style="margin-left:20px">
