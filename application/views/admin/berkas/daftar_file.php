            ...
            <div class="card card-danger">
			  ...
			  <?php
				...
				?>
							...
							<div class="card-body">
							<a href="<?=base_url('upload/form')?>" style="margin-bottom:10px;" class="btn btn-primary"><i class="fas fa-upload"></i> Upload File</a>
							<table id="example1" class="table table-responsive table-bordered table-striped">
								<thead>
								<tr>
									<th width="5%"><center>No</th>
									<th width="20%"><center>Nama File</th>
									<th width="12%"><center>Ukuran File</th>
									<th width="15%"><center>Tanggal Upload</th>
								...
								if(isset($daftar_file)){
									...
									<tr>
										...
										<td align="center"><?= date ("d-M-Y H:i:s", filemtime($dir.$daftar_file[$a]));?></td>
										<td align="center">
											<a href="<?= $dir.$daftar_file[$a];?>"><span class="fas fa-download"></span></a>
											<a href="<?= base_url().'upload/hapus/'.$daftar_file[$a];?>"><span class="fas fa-trash-alt"></span></a>
										</td>
									</tr>
									</tbody>
									<?php
