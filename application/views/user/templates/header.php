      ...
      <div class="container">
        <div class="navbar-header">
          ...
          <ul class="nav navbar-nav mr-auto">
            ...
            <li class="dropdown"><a class="bg-dark dropdown-toggle" data-toggle="dropdown" href="#"><i class="fa fa-database" aria-hidden="true"></i> Data Barang<span class="caret"></span></a>
