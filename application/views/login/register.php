    ...
    <div class="card-body register-card-body">
      ...
      <form action="<?= base_url('register/proses_register')?>" class="login" method="post">
        <div class="input-group mb-3">
          <input type="text" name="username" class="form-control" style="font-family: 'Be Vietnam', sans-serif;" placeholder="Username" autofocus required="">
        ...
        <div class="input-group mb-3">
          <input type="email" name="email" class="form-control" style="font-family: 'Be Vietnam', sans-serif;" placeholder="Email" autofocus required="">
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="input-group mb-3">
          <input type="password"name="password" class="form-control" style="font-family: 'Be Vietnam', sans-serif;" placeholder="Password" autofocus required="">
          <div class="input-group-append">
            <div class="input-group-text">
        ...
        <div class="input-group mb-3">
          <input type="password" name="confirm_password" class="form-control" style="font-family: 'Be Vietnam', sans-serif;" placeholder="Confirm password" autofocus required="">
          <div class="input-group-append">
            <div class="input-group-text">
              <span class="fas fa-lock"></span>
            </div>
        ...
        <div class="row">
          <div class="col-8">
		  			<a href="<?= base_url('login'); ?>" class="text-center" style="font-family: 'Carter One', cursive;">Sign In</a>
          </div>
          <!-- /.col -->
          <div class="col-4">
